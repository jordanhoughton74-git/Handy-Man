  ...
  <footer className="text-gray-600 body-font bg-gray-700">
    ...
    >
      ...
      <g transform="matrix(1.33333 0 0 -1.33333 -59.83 788.319)">
        ...
        <p className="mt-2 text-sm text-white">Local Handyman and Renovation Services</p>
      </div>
    ...
    <div className="bg-gray-900">
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        <p className="text-white text-sm text-center sm:text-left">© {new Date().getFullYear()} Zorilov Handyman</p>
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start text-gray-200">
